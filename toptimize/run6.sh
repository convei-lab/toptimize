...
# Citeseer
# python train.py no_drop_alpha7 -b GCN -d Citeseer -r 10 -m 7
# python train.py no_drop_alpha7_2 -b GCN -d Citeseer -r 10 -m 7

# Cold Start
python train.py cs_0.25 -b GCN -d Citeseer -r 50 -m 7 -c 0.25
...
# # GAT
# python train.py test -b GAT -d Cora -r 100 -m 10 -k 0 -w
