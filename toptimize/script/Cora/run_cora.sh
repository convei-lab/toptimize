...
## Ours
python train.py "Cora_cikm/test" -b GCN -d Cora -tr 0 -t 5 -et -t 20 -csr 0.25
...
## Ours
# On Test
# python train.py "dev" -b GAT -d Cora -tr 20 -t 3 -sm -ts 20
...
# python train.py "Coldstart/Cora/0_paper" -b GAT -d Cora -tr 50 -t 3 -csr 0.0005
