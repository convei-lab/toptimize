...
# python train.py "dev3" -b GCN -d Cora -tr 20 -t 8 -te 300 -ts 20
python train.py "dev4" -b GCN -d Cora -tr 20 -t 7 -te 300 -ts 20 -sm
...
# python train.py "Cora/dev" -b GAT -d Cora -tr 10 -t 9 -te 300
