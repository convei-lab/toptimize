...
python attack.py "PA-pubmed-GCN-ptb5"  pgd_attack dev_Pubmed_GCN -tr 12 -vm  0 -vt 0 -ptb 0.05 -ca -ts 0   
python attack.py "PA-pubmed-GCN-ptb5"  pgd_attack dev_Pubmed_GCN -tr 12 -vm  0 -vt 0 -ptb 0.05 -ca -ts 5 -t 9
python attack.py "PA-pubmed-GCN-ptb10" pgd_attack dev_Pubmed_GCN -tr 12 -vm  0 -vt 0 -ptb 0.1  -ca -ts 0
python attack.py "PA-pubmed-GCN-ptb10" pgd_attack dev_Pubmed_GCN -tr 12 -vm  0 -vt 0 -ptb 0.1  -ca -ts 5 -t 9
python attack.py "PA-pubmed-GCN-ptb15" pgd_attack dev_Pubmed_GCN -tr 12 -vm  0 -vt 0 -ptb 0.15 -ca -ts 0 
python attack.py "PA-pubmed-GCN-ptb15" pgd_attack dev_Pubmed_GCN -tr 12 -vm  0 -vt 0 -ptb 0.15 -ca -ts 5 -t 9
python attack.py "PA-pubmed-GCN-ptb20" pgd_attack dev_Pubmed_GCN -tr 12 -vm  0 -vt 0 -ptb 0.20 -ca -ts 0
python attack.py "PA-pubmed-GCN-ptb20" pgd_attack dev_Pubmed_GCN -tr 12 -vm  0 -vt 0 -ptb 0.20 -ca -ts 5 -t 9