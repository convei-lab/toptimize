...
python attack.py "model-dev8/base-ptb15" pgd_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.15 -ca -ts 0      
python attack.py "model-dev8/ours-ptb15" pgd_attack dev-8_Cora_GCN -tr 19 -vm 20 -vt 0 -ptb 0.15 -ca -ts 5 -t 10
