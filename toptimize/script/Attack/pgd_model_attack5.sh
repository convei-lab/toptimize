...
python attack_gat.py "RA-base-GAT-ptb5"  random_attack dev-8_Cora_GCN -tr 9 -vm  0 -vt 0 -ptb 0.5 -ca -ts 0      
python attack_gat.py "RA-ours-GAT-ptb5"  random_attack dev-8_Cora_GCN -tr 9 -vm  0 -vt 0 -ptb 0.5 -ca -ts 5 -t 10
python attack_gat.py "RA-base-GAT-ptb10" random_attack dev-8_Cora_GCN -tr 9 -vm  0 -vt 0 -ptb 1.0  -ca -ts 0      
python attack_gat.py "RA-ours-GAT-ptb10" random_attack dev-8_Cora_GCN -tr 9 -vm  0 -vt 0 -ptb 1.0  -ca -ts 5 -t 10
...
# python attack_gat.py "citeseer-GAT-ptb5"  pgd_attack dev-6_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.05 -ca -ts 0      
# python attack_gat.py "citeseer-GAT-ptb5"  pgd_attack dev-6_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.05 -ca -ts 5 -t 10
# python attack_gat.py "citeseer-GAT-ptb10" pgd_attack dev-6_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.1  -ca -ts 0      
# python attack_gat.py "citeseer-GAT-ptb10" pgd_attack dev-6_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.1  -ca -ts 5 -t 10