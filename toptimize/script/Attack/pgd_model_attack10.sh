...
python attack_gat.py "RA1-base-GAT-ptb15" random_attack dev-7_Citeseer_GCN -tr 9 -vm  0 -vt 0 -ptb 1.5 -ca -ts 0 
python attack_gat.py "RA1-ours-GAT-ptb15" random_attack dev-7_Citeseer_GCN -tr 9 -vm  0 -vt 0 -ptb 1.5 -ca -ts 5 -t 0.2
python attack_gat.py "RA1-base-GAT-ptb20" random_attack dev-7_Citeseer_GCN -tr 9 -vm  0 -vt 0 -ptb 2.0 -ca -ts 0
python attack_gat.py "RA1-ours-GAT-ptb20" random_attack dev-7_Citeseer_GCN -tr 9 -vm  0 -vt 0 -ptb 2.0 -ca -ts 5 -t 0.2