...
# Random Model Attack Citeseer
# python attack_gat.py "RA-citeseer-GAT-ptb5"  random_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.05 -ca -ts 0      
# python attack_gat.py "RA-citeseer-GAT-ptb5"  random_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.05 -ca -ts 5 -t 10
# python attack_gat.py "RA-citeseer-GAT-ptb10" random_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.1  -ca -ts 0      
# python attack_gat.py "RA-citeseer-GAT-ptb10" random_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.1  -ca -ts 5 -t 10
# python attack_gat.py "RA-citeseer-GAT-ptb15" random_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.15 -ca -ts 0       
# python attack_gat.py "RA-citeseer-GAT-ptb15" random_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.15 -ca -ts 5 -t 10
# python attack_gat.py "RA-citeseer-GAT-ptb20" random_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.20 -ca -ts 0      
# python attack_gat.py "RA-citeseer-GAT-ptb20" random_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.20 -ca -ts 5 -t 10

python attack_gat.py "PA1-cora-base-ptb5"  pgd_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.05 -ca -ts 0      
python attack_gat.py "PA1-cora-ours-ptb5"  pgd_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.05 -ca -ts 5 -t 10
python attack_gat.py "PA1-cora-base-ptb10" pgd_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.1  -ca -ts 0      
python attack_gat.py "PA1-cora-ours-ptb10" pgd_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.1  -ca -ts 5 -t 10
# python attack_gat.py "PA1-cora-GAT-ptb15" pgd_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.15 -ca -ts 0       
# python attack_gat.py "PA1-cora-GAT-ptb15" pgd_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.15 -ca -ts 5 -t 10
# python attack_gat.py "PA1-cora-GAT-ptb20" pgd_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.20 -ca -ts 0      
# python attack_gat.py "PA1-cora-GAT-ptb20" pgd_attack dev-8_Cora_GCN -tr 19 -vm  0 -vt 0 -ptb 0.20 -ca -ts 5 -t 10
