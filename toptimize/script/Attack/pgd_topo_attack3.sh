...
python attack.py "topo-6-citeseer/base-ptb5"  pgd_attack dev-6_Citeseer_GCN -tr 19 -vm 0 -vt 0  -ptb 0.05 -ca -ts 0
python attack.py "topo-6-citeseer/ours-ptb5"  pgd_attack dev-6_Citeseer_GCN -tr 19 -vm 0 -vt 20 -ptb 0.05 -ca -ts 0
python attack.py "topo-6-citeseer/base-ptb10" pgd_attack dev-6_Citeseer_GCN -tr 19 -vm 0 -vt 0  -ptb 0.1  -ca -ts 0
python attack.py "topo-6-citeseer/ours-ptb10" pgd_attack dev-6_Citeseer_GCN -tr 19 -vm 0 -vt 20 -ptb 0.1  -ca -ts 0
