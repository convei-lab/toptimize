...
python attack_gat.py "RA-base-GAT-ptb15" random_attack dev-8_Cora_GCN -tr 9 -vm  0 -vt 0 -ptb 1.5 -ca -ts 0       
python attack_gat.py "RA-ours-GAT-ptb15" random_attack dev-8_Cora_GCN -tr 9 -vm  0 -vt 0 -ptb 1.5 -ca -ts 5 -t 10
python attack_gat.py "RA-base-GAT-ptb20" random_attack dev-8_Cora_GCN -tr 9 -vm  0 -vt 0 -ptb 2.0 -ca -ts 0      
python attack_gat.py "RA-ours-GAT-ptb20" random_attack dev-8_Cora_GCN -tr 9 -vm  0 -vt 0 -ptb 2.0 -ca -ts 5 -t 10
