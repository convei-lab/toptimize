...
# python attack_gat.py "citeseer-GAT-ptb5"  pgd_attack dev-7_Cora_GCN -vr 19 -vm  0 -vt 0 -ptb 0.05 -ca -ts 0      
# python attack_gat.py "citeseer-GAT-ptb5"  pgd_attack dev-7_Cora_GCN -vr 19 -vm  0 -vt 0 -ptb 0.05 -ca -ts 5 -t 10
# python attack_gat.py "citeseer-GAT-ptb10" pgd_attack dev-7_Cora_GCN -vr 19 -vm  0 -vt 0 -ptb 0.1  -ca -ts 0      
# python attack_gat.py "citeseer-GAT-ptb10" pgd_attack dev-7_Cora_GCN -vr 19 -vm  0 -vt 0 -ptb 0.1  -ca -ts 5 -t 10
python attack_gat.py "base-GAT-ptb15" pgd_attack dev-6_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.15 -ca -ts 0       
python attack_gat.py "ours-GAT-ptb15" pgd_attack dev-6_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.15 -ca -ts 5 -t 0.2
python attack_gat.py "base-GAT-ptb20" pgd_attack dev-6_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.20 -ca -ts 0      
python attack_gat.py "ours-GAT-ptb20" pgd_attack dev-6_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.20 -ca -ts 5 -t 0.2
