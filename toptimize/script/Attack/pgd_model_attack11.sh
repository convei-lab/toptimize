...
# python attack_gat.py "RA1-citeseer-GAT-ptb5"  random_attack dev-7_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.05 -ca -ts 0   
# python attack_gat.py "RA1-citeseer-GAT-ptb5"  random_attack dev-7_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.05 -ca -ts 5 -t 0.2
# python attack_gat.py "RA1-citeseer-GAT-ptb10" random_attack dev-7_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.1  -ca -ts 0
# python attack_gat.py "RA1-citeseer-GAT-ptb10" random_attack dev-7_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.1  -ca -ts 5 -t 0.2
# python attack_gat.py "RA1-citeseer-GAT-ptb15" random_attack dev-7_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.15 -ca -ts 0 
# python attack_gat.py "RA1-citeseer-GAT-ptb15" random_attack dev-7_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.15 -ca -ts 5 -t 0.2
# python attack_gat.py "RA1-citeseer-GAT-ptb20" random_attack dev-7_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.20 -ca -ts 0
# python attack_gat.py "RA1-citeseer-GAT-ptb20" random_attack dev-7_Citeseer_GCN -tr 19 -vm  0 -vt 0 -ptb 0.20 -ca -ts 5 -t 0.2

python attack.py "base-pubmed-GCN-ptb5"  random_attack dev_Pubmed_GCN -tr 5 -vm  0 -vt 0 -ptb 0.5 -ca -ts 0   
python attack.py "ours-pubmed-GCN-ptb5"  random_attack dev_Pubmed_GCN -tr 5 -vm  0 -vt 0 -ptb 0.5 -ca -ts 5 -t 9
python attack.py "base-pubmed-GCN-ptb10" random_attack dev_Pubmed_GCN -tr 5 -vm  0 -vt 0 -ptb 1.0  -ca -ts 0
python attack.py "ours-pubmed-GCN-ptb10" random_attack dev_Pubmed_GCN -tr 5 -vm  0 -vt 0 -ptb 1.0  -ca -ts 5 -t 9
python attack.py "base-pubmed-GCN-ptb15" random_attack dev_Pubmed_GCN -tr 5 -vm  0 -vt 0 -ptb 1.5 -ca -ts 0 
python attack.py "ours-pubmed-GCN-ptb15" random_attack dev_Pubmed_GCN -tr 5 -vm  0 -vt 0 -ptb 1.5 -ca -ts 5 -t 9
python attack.py "base-pubmed-GCN-ptb20" random_attack dev_Pubmed_GCN -tr 5 -vm  0 -vt 0 -ptb 2.0 -ca -ts 0
python attack.py "ours-pubmed-GCN-ptb20" random_attack dev_Pubmed_GCN -tr 5 -vm  0 -vt 0 -ptb 2.0 -ca -ts 5 -t 9